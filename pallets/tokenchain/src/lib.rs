...
pub mod pallet {
	use frame_support::{pallet_prelude::*, traits::Currency, inherent::Vec, Twox64Concat, sp_runtime::traits::Hash};
...
// use sp_runtime::AccountId32;
	...
	impl<T: Config> Pallet<T> {
		...
		#[pallet::weight(10000)] // computational weight of this extrinsic
