...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("node-tokenchain"),
	impl_name: create_runtime_str!("node-tokenchain"),
	authoring_version: 1,
...
/// Configure the pallet-tokenchain in pallets/tokenchain.
impl pallet_tokenchain::Config for Runtime {
	type Event = Event;
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Sudo: pallet_sudo,
		// Include the custom logic from the pallet-tokenchain in the runtime.
		TockenChain: pallet_tokenchain,
	}
);
